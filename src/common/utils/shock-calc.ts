...
export const COUNTRY_COORDS: Record<string, { lat: number; lng: number }> = {
  ...
  CZ: { lat: 50.08, lng: 14.43 },
  SK: { lat: 48.15, lng: 17.11 },
  BG: { lat: 42.7, lng: 23.32 },
  HR: { lat: 45.81, lng: 15.98 },
  RS: { lat: 44.79, lng: 20.47 },
  GE: { lat: 42.32, lng: 43.36 },
  AZ: { lat: 40.41, lng: 49.87 },
  AM: { lat: 40.18, lng: 44.51 },
  KZ: { lat: 51.17, lng: 71.45 },
  UZ: { lat: 41.3, lng: 69.28 },
  TM: { lat: 37.96, lng: 58.38 },
  KG: { lat: 42.87, lng: 74.59 },
  TJ: { lat: 38.56, lng: 68.77 },
  AO: { lat: -8.84, lng: 13.23 },
  CU: { lat: 23.11, lng: -82.37 },
  JO: { lat: 31.96, lng: 35.95 },
  TN: { lat: 36.81, lng: 10.17 },
  DZ: { lat: 36.74, lng: 3.09 },
  MA: { lat: 33.97, lng: -6.85 },
  GH: { lat: 7.95, lng: -1.03 },
  ...
  // Full names for expanded coverage
  ...
  Jordan: { lat: 31.96, lng: 35.95 },
  Tunisia: { lat: 36.81, lng: 10.17 },
  Algeria: { lat: 36.74, lng: 3.09 },
